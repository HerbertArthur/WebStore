...
<form id="orderForm" class="hide" action="/order/create.html" method="post">
	...
	<input type="hidden" name="orderShipping.receiverName" value="苏大强"/>
	...
	<input type="hidden" name="orderShipping.receiverAddress" value="北京市昌平区昌平小区"/>
</form>
  ...
  <div id="userAddrId" class="orderTbody ">
    ...
    <div class="orderItem">
        <div class="orderCurr" id="userAddress" style="display:block;">
          <ul>
            <li>苏大强&nbsp;&nbsp;&nbsp;&nbsp;15888888888&nbsp;&nbsp;&nbsp;&nbsp;北京市&nbsp;&nbsp;昌平区&nbsp;&nbsp;昌平小区</li>
          </ul>
        </div>
    </div>
  </div>
		...
		<div class="shipment">
			<div class="shipOrder" id="ylsorder2">
				<div class="sOrders">
					...
					<div class="sOrders">
						<div class="scon">
							<strong>京东速递</strong>负责配送。<br>商品下单后尽快为您发货
						</div>
					</div>
