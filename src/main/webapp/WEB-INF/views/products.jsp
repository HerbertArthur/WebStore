...
<link rel="stylesheet" href='<c:url value="/WEB-INF/resources/css/styles.css" />' type="text/css" media="screen" />
<script src="https://ajax.googleapis.com/ajax/libs/angularjs/1.0.1/angular.min.js"></script>
<script src="http://ajax.googleapis.com/ajax/libs/jquery/1.8.2/jquery.min.js"></script>
<script src='<c:url value="/WEB-INF/resources/js/controllers.js" />'></script>
<script src='<c:url value="/WEB-INF/resources/js/scripts.js" />'></script>
